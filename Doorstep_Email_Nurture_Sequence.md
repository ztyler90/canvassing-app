# Doorstep — Post-Gate Email Nurture Sequence

**Companion to:** PRD — AI Homeowner Role-Play
**Sequence type:** Lead nurture (free → paid)
**Goal:** Convert free, email-gated users into paid Doorstep plans — route reps to Starter/Growth self-serve, route managers/owners to a Teams/Enterprise conversation.
...
|---|---|---|---|---|---|
| 1 | "Your Doorstep score is saved 🚪" | Welcome, anchor the score, prompt next session | Day 0 (within minutes of gate) | Run your next session | All |
...
| # | Subject (lead option) | Purpose | Timing | Primary CTA | Condition |
|---|---|---|---|---|---|
| M1 | "Get new reps knocking faster" | Reframe Doorstep as an onboarding system | Day 0 | See the manager view | role=manager / team_size>1 |
...
- **Subject options:** "Your Doorstep score is saved 🚪" · "{{first_name}}, you scored {{last_score}}" · "Nice first reps — here's what's next"
...
- **Body:**
  ...
  >
  > Want to drill it? Run a session and focus only on your first two lines. Doorstep's homeowner will react like the real thing.
...
- **Body:**
  ...
  >
  > That's all Doorstep is: a realistic door you can knock as many times as you want, with instant coaching on what landed and what didn't.
  >
...
- **Body:**
  ...
  >
  > Doorstep Teams lets you assign practice, set a "ready to knock" bar, and see each rep's scores and weak spots — so nobody learns on your best neighborhoods.
...
- **Body:**
  ...
  >
  > Doorstep compresses that. Reps drill objections until the answers are automatic, earn a **"Doorstep Certified"** badge, and you get a ramp scorecard showing exactly who's ready.
- **CTA:** **Explore Teams →**
